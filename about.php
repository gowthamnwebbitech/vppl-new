...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .vppl-hero-title { font-size: clamp(36px, 6vw, 64px); font-weight: 900; line-height: 1.1; letter-spacing: -1.5px; }
        .vppl-gradient-text { background: var(--grad-accent); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }

        /* --- NEW MINIMAL STATS WRAPPER --- */
        .vppl-stats-wrapper { 
            padding: 80px 0; 
        ...
        /* --- Story Section --- */
        .vppl-story { padding: 120px 0; }
        .vppl-grid { display: grid; grid-template-columns: repeat(12, 1fr); gap: 80px; align-items: center; }
        .vppl-text-area { grid-column: span 7; }
        .vppl-image-area { grid-column: span 5; }

        .vppl-tag { display: inline-block; background: rgba(34, 164, 212, 0.1); color: var(--vppl-primary); padding: 6px 18px; border-radius: 4px; font-weight: 800; font-size: 11px; margin-bottom: 20px; border-left: 4px solid var(--vppl-primary); text-transform: uppercase; }
        .vppl-h2 { font-size: 44px; font-weight: 800; color: var(--vppl-secondary); margin-bottom: 25px; line-height: 1.2; }
        
        /* --- Buttons --- */
        .vppl-btn-group { display: flex; gap: 15px; margin-top: 35px; }
        .vppl-btn { padding: 16px 32px; border-radius: 8px; font-weight: 700; text-decoration: none; transition: 0.3s; font-size: 14px; display: inline-block; }
        .vppl-btn-primary { background: var(--vppl-secondary); color: white; }
        .vppl-btn-primary:hover { background: var(--vppl-primary); transform: translateY(-3px); }
        .vppl-btn-outline { border: 1px solid var(--vppl-border); color: var(--vppl-secondary); }
        .vppl-btn-outline:hover { border-color: var(--vppl-primary); color: var(--vppl-primary); }

        /* --- Bento Grid --- */
        .vppl-bento-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; }
        .vppl-bento-item { border-radius: var(--r-custom); overflow: hidden; background: #f8fafc; }
        .vppl-bento-item img { width: 100%; height: 100%; object-fit: cover; display: block; }
        .vppl-bento-stats { background: var(--grad-primary); color: white; padding: 30px; text-align: center; display: flex; flex-direction: column; justify-content: center; }

        @media (max-width: 991px) {
            .vppl-grid { grid-template-columns: 1fr; }
            .vppl-text-area, .vppl-image-area { grid-column: span 1; }
            .vppl-stats-minimal { grid-template-columns: repeat(2, 1fr); gap: 40px; }
            .vppl-stat-item:nth-child(2)::after { display: none; }
        }
        @media (max-width: 576px) {
            .vppl-stats-minimal { grid-template-columns: 1fr; text-align: center; }
            .vppl-stat-item::after { display: none; }
        }
    </style>
</head>
...
<body>
                ...
                <div class="vppl-container">
                    <div class="vppl-grid">
                        <div class="vppl-text-area gsap-reveal">
                            ...
                            <h2 class="vppl-h2">Driving Industrial <span class="vppl-gradient-text">Transformation</span></h2>
                            <p style="margin-bottom: 20px; font-size: 17px; color: var(--vppl-gray);">
                                VPPL stands at the forefront of engineering innovation. We specialize in delivering high-efficiency turnkey solutions for the renewable energy and manufacturing sectors.
                            </p>
                        ...
                        <div class="vppl-image-area gsap-reveal">
                            <div class="vppl-bento-grid">
                                ...
                                <div class="vppl-bento-item vppl-bento-stats bento-anim">
                                    ...
                                    <p style="font-size: 11px; text-transform: uppercase; letter-spacing: 1px;">Standard</p>
                                </div>
    ...
    <script>
        ...
        // Entrance
        gsap.to(".vppl-hero-content", { opacity: 1, y: 0, duration: 1.2, ease: "power3.out", delay: 0.2 });
