...
$hero_main_text = "Water <span class='vppl-gradient-text'>Treatment</span> Plant";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        ...
        /* --- Dynamic Hero (Consistent with previous pages) --- */
        .vppl-hero {
            height: 45vh;
            min-height: 350px;
                    ...
                    <div class="row g-0 g-lg-5 mobile-reverse">
                        ...
                        <div class="col-lg-3">
                            <div class="service-nav-card">
                                <a href="service-single.php" class="service-link active">Water Treatment Plant</a>
                        ...
                        <div class="col-lg-9">
                            <div class="row g-4 mb-5">
                                <div class="col-lg-7">
                                    <h2 class="fw-bold mb-4">Pure Water Through <span
                                            class="vppl-gradient-text">Advanced Engineering</span></h2>
