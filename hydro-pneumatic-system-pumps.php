                    ...
                    <div class="row g-0 g-lg-5 mobile-reverse">
                        ...
                        <div class="col-lg-3">
                            <div class="service-nav-card">
                                ...
                                <a href="hydro-pneumatic-system-pumps.php" class="service-link active">Hydro Pneumatic
                                    Pumps</a>

                                <div class="cta-card">
                                    <h6 class="text-uppercase mb-2" style="letter-spacing: 2px;">Need Help?</h6>
                                    <p class="small opacity-75">Contact our technical team for custom plant design.</p>
                                    <a href="tel:+919943835148" class="text-white fw-bold text-decoration-none">
                                        <i class="fa fa-phone me-2"></i> +91 99438 35148
                                    </a>
                                    <a href="mailto:venkadavanprojectschennai@gmail.com" class="cta-btn">Enquire Now</a>
                                </div>
                            </div>
                        </div>
