...
$page_title = "Sewage Treatment Plant";
$parent_page = "Projects";
$hero_bg = "sub-banner.webp";
$hero_main_text = "Sewage <span class='vppl-gradient-text'>Treatment</span> Plant";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        /* --- COPY YOUR EXISTING CSS BLOCK HERE --- */
        :root {
            --vppl-primary: #22a4d4;
                        ...
                        <div class="col-lg-3">
                            <div class="service-nav-card">
                                ...
                                <a href="iron-removal-plant.php"
                                    ...
                                    Removal Plant</a>
                                <a href="mineral-water-treatment-plant.php"
                                    class="service-link <?php echo ($page_title == 'Mineral Water Plant') ? 'active' : ''; ?>">Mineral
                                    Water Plant</a>
